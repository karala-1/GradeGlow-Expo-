...
$sql = "SELECT * FROM notas_2 WHERE student_id = '$student_id'";
...
<body>
    <div class="container">
        <div class="header">
            <!-- <h2>Informatica</h2> -->
            <center><h2>Bienvenido "<?php echo $fullname; ?>"</h2></center><br><br><br><br>
        </div>
        ...
        <div class="module-grades">
            ...
            if ($result->num_rows > 0) {
                ...
                echo "<div>Codewars <br> $nota1</div>";
                echo "<div>Página web <br> $nota2</div>";
                echo "<div>Hackathon <br> $nota3</div>";
...
<?php
$con->close(); // Cerrar la conexión aquí al final, solo una vez
?>
